...
**Goals:** DNS is clean, SSL is working, [Pi-hole](../apps/pi-hole.md) is blocking ads network-wide.

- [ ] Deploy [Pi-hole](../apps/pi-hole.md) + [Unbound](../apps/unbound.md) on Pi 4B
...
- [ ] Deploy [Nginx Proxy Manager](../apps/nginx-proxy-manager.md) on IBM
...
- [ ] Deploy [NetBird](../apps/netbird.md) management server on IBM
...
- [ ] Deploy [Vaultwarden](../apps/vaultwarden.md) on IBM → `vault.srng.no` 🔒
- [ ] Migrate all passwords into Vaultwarden
- [ ] Install Bitwarden app on all personal devices
- [ ] Deploy [Authelia](../apps/authelia.md) on IBM
- [ ] Integrate Authelia with [Nginx Proxy Manager](../apps/nginx-proxy-manager.md)
- [ ] Deploy [CrowdSec](../apps/crowdsec.md) on IBM + configure NPM bouncer
...
- [ ] Deploy [Prowlarr](../apps/prowlarr.md) on IBM
- [ ] Deploy [Radarr](../apps/radarr.md) on IBM → connect to Prowlarr
- [ ] Deploy [Sonarr](../apps/sonarr.md) on IBM → connect to Prowlarr
- [ ] Deploy [Lidarr](../apps/lidarr.md) on IBM → connect to Prowlarr
- [ ] Deploy [Readarr](../apps/readarr.md) on IBM → connect to Prowlarr
- [ ] Deploy [qBittorrent](../apps/qbittorrent.md) on IBM → connect to all *arrs
- [ ] Deploy [Bazarr](../apps/bazarr.md) on IBM → connect to Radarr + Sonarr
...
- [ ] Deploy [Plex](../apps/plex.md) on Ubuntu → point library at NFS mount from IBM
...
- [ ] Deploy [Overseerr](../apps/overseerr.md) on IBM → connect to [Radarr](../apps/radarr.md) + [Sonarr](../apps/sonarr.md)
...
- [ ] Deploy [Nextcloud](../apps/nextcloud.md) on IBM → storage on ZFS pool
- [ ] Expose `cloud.srng.no` via NPM 🔒
- [ ] Configure Nextcloud email, calendar, and contacts apps
- [ ] Deploy [Paperless-ngx](../apps/paperless-ngx.md) on IBM
- [ ] Expose `paper.srng.no` via NPM 🔒
- [ ] Deploy [Syncthing](../apps/syncthing.md) on IBM → set up sync on personal devices
- [ ] Deploy [Filebrowser](../apps/filebrowser.md) on IBM
...
- [ ] Deploy [Immich](../apps/immich.md) on Ubuntu (GPU-accelerated ML)
...
- [ ] Deploy [Navidrome](../apps/navidrome.md) on IBM → point at music library on ZFS
- [ ] Expose `music.srng.no` publicly via NPM 🌐
- [ ] Deploy [Audiobookshelf](../apps/audiobookshelf.md) on IBM
...
- [ ] Deploy [Prometheus](../apps/prometheus.md) on IBM
- [ ] Deploy [Grafana](../apps/grafana.md) on IBM → connect to Prometheus
...
- [ ] Deploy [Uptime Kuma](../apps/uptime-kuma.md) on IBM → add all running services
- [ ] Expose `status.srng.no` via NPM 🔒
- [ ] Deploy [Netdata](../apps/netdata.md) on IBM + Ubuntu
- [ ] Deploy [Dozzle](../apps/dozzle.md) on IBM
- [ ] Deploy [Watchtower](../apps/watchtower.md) on IBM (auto-updates all containers)
...
- [ ] Deploy [Home Assistant](../apps/home-assistant.md) on IBM
- [ ] Expose `home.srng.no` via NPM 🔒
- [ ] Deploy [Mosquitto](../apps/mosquitto.md) MQTT broker on Pi 4B
- [ ] Deploy [Zigbee2MQTT](../apps/zigbee2mqtt.md) on Pi 4B *(if you have Zigbee devices)*
- [ ] Connect Zigbee2MQTT to Home Assistant via MQTT
- [ ] Deploy [Node-RED](../apps/node-red.md) on IBM → connect to Home Assistant
...
- [ ] Deploy [Portainer](../apps/portainer.md) on IBM
- [ ] Expose `docker.srng.no` via NPM 🔒
- [ ] Deploy [Gitea](../apps/gitea.md) / Forgejo on IBM
- [ ] Expose `git.srng.no` via NPM 🔒
- [ ] Push your homelab repo to self-hosted Gitea
- [ ] Deploy [Wiki.js](../apps/wiki-js.md) or BookStack on IBM
- [ ] Expose `docs.srng.no` via NPM 🔒
- [ ] Deploy [Stirling-PDF](../apps/stirling-pdf.md) on IBM
- [ ] Deploy [IT-Tools](../apps/it-tools.md) on IBM
- [ ] Deploy [Homepage](../apps/homepage.md) dashboard on IBM → add widgets for all services
- [ ] Expose `dash.srng.no` via NPM 🔒
- [ ] Deploy [code-server](../apps/code-server.md) on Ubuntu
...
- [ ] Build [llama.cpp](../apps/llama-cpp.md) from source with CUDA support
...
- [ ] Deploy [Open WebUI](../apps/open-webui.md) → connect to llama-server
- [ ] Expose `ai.srng.no` via NPM 🔒
- [ ] Install Automatic1111 [Stable Diffusion](../apps/stable-diffusion.md) on Ubuntu
...
- [ ] Deploy [Calibre-Web](../apps/calibre-web.md) on IBM → point at ebook library
- [ ] Deploy [Kavita](../apps/kavita.md) on IBM → point at comics/manga library
- [ ] Deploy [Beets](../apps/beets.md) on IBM → run auto-tagger on music library
...
- [ ] Reboot Ubuntu → verify [Plex](../apps/plex.md) + GPU services recover
